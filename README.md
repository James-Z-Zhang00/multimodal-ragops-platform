...
- **[multiagent-research-system](../multiagent-research-system)** _(coming soon)_ — Autonomous multi-agent research system with three-tier memory, LLM-as-Judge quality gate, and LangGraph orchestration
